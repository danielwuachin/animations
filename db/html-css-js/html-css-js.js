  ...
  projects: [
    {
      ...
      path: "html-css-js/floating-placeholder",
      ...
      * {
      ...
      js: "let label = document.querySelectorAll('label');  label.forEach((item) => {  item.innerHTML = item.innerText.split('').map((letter, i) => `<span style=\"transition-delay:${i * 50}ms\">${letter}</span>`).join('');});",
    },
    {
      id: 2,
